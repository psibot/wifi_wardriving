...
echo -e "\e[32m[-]\e[0m \e[1m   Choose : Hit '18' for Fluxion !!!\e[0m"
...
function fluxion() 
{
    ...
    echo -s "Enjoy!"
    echo -s " to run as root  or sudo "
    echo -s " sudo /tmp/fluxion/fluxion"
    echo -s "also check https://github.com/deltaxflux/fluxion-gui.git for GUI"
    sleep 10
    clear
}
